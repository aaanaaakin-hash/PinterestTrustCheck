...
Но антивирусы иногда ворчат на любыеUnsigned-программы из интернета, которые ходят в сеть. Что делать:
...
жалобы. Проверь ссылку черновиком пина: если Pinterest пишет про спам — дело в домене, если молчит — в аккаунте.
...
- `run-web.bat` — тёмный интерфейс в браузере
- `run.bat` — пакетная проверка из `links.txt`
- `install.bat` — качает Go в папку `.tools` и собирает программу (нужен интернет один раз)
- `make-release.bat` — собирает архив для раздачи
